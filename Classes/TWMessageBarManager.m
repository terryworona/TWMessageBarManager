...
+ (void)initialize
{
	...
	{
        // Colors (background)
        kTWDefaultMessageBarStyleSheetErrorBackgroundColor = [UIColor colorWithRed:1.0f green:0.611f blue:0.0f alpha:kTWMessageBarStyleSheetMessageBarAlpha]; // orange
        ...
        kTWDefaultMessageBarStyleSheetInfoBackgroundColor = [UIColor colorWithRed:0.0f green:0.482f blue:1.0f alpha:kTWMessageBarStyleSheetMessageBarAlpha]; // blue
